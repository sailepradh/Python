...
def translateCodon(x):
    ...
    if codon in exerciseWeek4.aminoAcidMap:
        # return the aminoacid by looking up in the dictionary:
        return exerciseWeek4.aminoAcidMap[codon]
    else:
...
#     # define a list for the results to be returned from the function:
#     result = []
#     for i in range((len(orf)+2)/3):
#         result.append(orf[3*i:3*(i+1)])
#     return result
...
def findStartPositions(seq):
    ...
    for i in range(len(seq)-2):
        ...
        if seq[i:i+3] == exerciseWeek4.startCodon:
...
if __name__ == "__main__":
    ...
    orf = exerciseWeek4.exactGenes[0]
    seq = exerciseWeek4.approximateGenes[0]

    print translateCodon("ACG")
    print splitCodons(orf)
    print translateSequence(orf)
